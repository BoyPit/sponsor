...
// Returns the private 'App\Repository\UsrSponsorRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\UsrSponsorRepository.php';

return $this->privates['App\Repository\UsrSponsorRepository'] = new \App\Repository\UsrSponsorRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
