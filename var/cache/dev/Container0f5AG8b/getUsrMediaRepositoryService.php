...
// Returns the private 'App\Repository\UsrMediaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\UsrMediaRepository.php';

return $this->privates['App\Repository\UsrMediaRepository'] = new \App\Repository\UsrMediaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
