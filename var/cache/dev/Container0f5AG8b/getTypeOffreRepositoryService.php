...
// Returns the private 'App\Repository\TypeOffreRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TypeOffreRepository.php';

return $this->privates['App\Repository\TypeOffreRepository'] = new \App\Repository\TypeOffreRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
