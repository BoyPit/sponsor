...
// Returns the private 'App\Repository\TypeReseauRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TypeReseauRepository.php';

return $this->privates['App\Repository\TypeReseauRepository'] = new \App\Repository\TypeReseauRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
