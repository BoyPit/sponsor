...
$a->setNamespace('sf_orm_default_e447d29cd30beb614efa99b05fb804023e4c0c155b698999e82d53db9997d8af');

$b = new \Doctrine\Common\Cache\ArrayCache();
$b->setNamespace('sf_orm_default_e447d29cd30beb614efa99b05fb804023e4c0c155b698999e82d53db9997d8af');

$c = new \Doctrine\Common\Cache\ArrayCache();
$c->setNamespace('sf_orm_default_e447d29cd30beb614efa99b05fb804023e4c0c155b698999e82d53db9997d8af');
...
$e->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\AnnonceRepository' => function () {
    return ($this->privates['App\Repository\AnnonceRepository'] ?? $this->load(__DIR__.'/getAnnonceRepositoryService.php'));
}, 'App\\Repository\\TypeOffreRepository' => function () {
    return ($this->privates['App\Repository\TypeOffreRepository'] ?? $this->load(__DIR__.'/getTypeOffreRepositoryService.php'));
}, 'App\\Repository\\TypeReseauRepository' => function () {
    return ($this->privates['App\Repository\TypeReseauRepository'] ?? $this->load(__DIR__.'/getTypeReseauRepositoryService.php'));
}, 'App\\Repository\\UsrMediaRepository' => function () {
    return ($this->privates['App\Repository\UsrMediaRepository'] ?? $this->load(__DIR__.'/getUsrMediaRepositoryService.php'));
}, 'App\\Repository\\UsrSponsorRepository' => function () {
    return ($this->privates['App\Repository\UsrSponsorRepository'] ?? $this->load(__DIR__.'/getUsrSponsorRepositoryService.php'));
}))));
